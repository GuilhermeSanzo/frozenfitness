<?php
	...
	require_once("php/crud_detalhes_artigo.php");
	...
	if(isset($_GET["artigo_id"])) {
		...
		header("location:dicas_fitness.php");
	}
  ...
  if (!isset($_SESSION['carrinho'])) {
	...
	$conexao = connect();
	$sql = "select * from artigo where artigo_id = ".$artigo_id;
	$select = mysqli_query($conexao,$sql);
	$array = mysqli_fetch_array($select);

	$categoria_artigo_id = $array['categoria_artigo_id'];
?>
...
<head>
	...
	<link href="css/detalhes_artigo.css" rel="stylesheet"/>

	<!-- Estilização Desktop -->
	<link href="css/mobile/template.css" rel="stylesheet"/>
	<link href="css/mobile/detalhes_artigo.css" rel="stylesheet"/>
