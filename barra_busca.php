<?php
	...
	require_once('php/crud_barra_busca.php');
	require_once('php/crud_categoria.php');

	if(isset($_POST["txtBarraBusca"])) {
		$txtBarraBusca = $_POST["txtBarraBusca"];
	} else {
...
<head>
	...
	<link href="css/mobile/categoria.css" rel="stylesheet"/>
		...
		<div class="conteudo">
			...
			<div class="esp_categoria">
				<div class="box_categoria">
					...
					<div class="categoria"> Hipertrofia </div>
					<div class="box_produtos">
						<?php

						ListarBarraBusca($txtBarraBusca);
