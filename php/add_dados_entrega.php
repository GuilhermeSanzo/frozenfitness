<?php
  ...
  if(isset($_POST['inserir'])) {
    ...
    $sql_data_pedido = "update pedido set dt_entrega_solic = '".$data_entrega."' where pedido_id =" .$pedido_id;
  ...
  if(isset($_POST['atualizar'])) {
    ...
    // Definindo a terceira página como padrão
    $_SESSION['processo_compra'] = 2;
