...
<head>
	...
	<link href="css/mobile/sobre_nos.css" rel="stylesheet"/>
...
<body>
	...
	<div class="esp_conteudo">
		...
		<div class="conteudo">
			<div class="box_title_e_subtitle">
				<div class="title">
					SOBRE FROZEN FITNESS GOURMET
				</div>
				<div class="subititle">
					A maneira mais fácil de comprar comida congelada
				</div>
			</div>

			<div class="box_conteudo_sobre">
				Integer enim neque, viverra a lobortis vitae, bibendum nec nulla, bibendum nec nulla
				Integer enim neque, viverra a lobortis vitae, bibendum nec nulla, bibend nulla
				Integer enim neque, viverra a lobortis vitae, bibendum nec nulla, bibendum nla
				Integer enim neque, viverra a lobortis vitae, bibendum nec nulla, bibenm nec nulla
			</div>
			<div class="box_conteudo_sobre">
				Integer enim neque, viverra a lobortis vitae, bibendum nec nulla, bibendum nec nulla
				Integer enim neque, viverra a lobortis vitae, bibendum nec nulla, bibend nulla
		...
		<div class="conteudo">
			...
			<div class="box_mapa_empresa"></div>
