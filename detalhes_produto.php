<?php
	...
	require_once('php/crud_detalhes_produto.php');

	$prato_id = null;

	if(isset($_GET["prato_id"])) {
		$prato_id = $_GET["prato_id"];
		echo "<div id='prato_id' style='display:none'>".$prato_id."</div>";
	} else {
...
<head>
	...
	<link href="css/mobile/detalhes_produto.css" rel="stylesheet"/>
