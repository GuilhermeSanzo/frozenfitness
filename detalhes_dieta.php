<?php
	...
	require_once('php/crud_detalhes_dieta.php');

	$prato_id = null;

	if(isset($_GET["dieta_id"])) {
		$dieta_id = $_GET["dieta_id"];
		echo "<div id='dieta_id' style='display:none'>".$dieta_id."</div>";
	} else {
...
<head>
	...
	<link href="css/detalhes_dieta.css" rel="stylesheet"/>
	
	<!-- Estilização Mobile -->
	<link href="css/mobile/template.css" rel="stylesheet"/>
	<link href="css/mobile/detalhes_dieta.css" rel="stylesheet"/>
	...
	<script src="js/detalhes_produto.js"></script>
