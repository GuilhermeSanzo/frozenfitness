<?php
	...
	require_once('php/crud_permissao.php');
					...
					<div class="cadastro_ingrediente">
						...
						<table>
							<tr>
								<td>Ingrediente: </td>
								<td>
									<select class="selecao_cadastro" class="cadastro_input" type="text" name="ingrediente">
							...
							<tr>
								<td>Fornecedor: </td>
								<td>
									<select class="selecao_cadastro" class="cadastro_input" type="text" name="fornecedor">
										"<option value='<?php echo $value_ingrediente ?>'><?php echo $fornecedor ?></option>"
										<?php
											$conexao = connect();
