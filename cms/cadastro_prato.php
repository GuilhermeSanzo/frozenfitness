<?php
	...
	require_once('php/crud_prato.php');
...
<head>
	...
	<script src="js/cadastro_prato.js?"></script>
				...
				<form name="form_parceiro" method="post" enctype="multipart/form-data" action="cadastro_prato.php<?php echo $modo ?>">
					<div class="cadastro_ingrediente">
						...
						<table>
							<tr>
								<td>Nome: </td>
								<td><input maxlength="36" class="cadastro_input" id="txtNome" type="text" name="nome" placeholder="Nome" value="<?php echo $nome ?>"></td>
							</tr>
							<tr>
								<td>Descrição do prato:</td>
								<td><textarea maxlength="180" id="txtDescricao" class="cadastro_input" style="height:150px;border-radius:10px" type="text" name="descricao" placeholder="Descricao"><?php echo $descricao ?></textarea></td>
							</tr>
							<tr>
								<td>Categoria do prato: </td>
								<td><select class="cadastro_input" type="text" name="tipo_dieta_id" id="tipo_dieta_id" class="tipo_dieta_id"></select></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Validade em dias: </td>
								<td><input class="cadastro_input" id="txtValidade" type="text" name="validade" placeholder="Ex: 3" value="<?php echo $validade ?>"></td>
							</tr>
							<tr>
								<td>Tempo de preparo em horas decimais: </td>
								<td><input class="cadastro_input" id="txtTempoPreparo" type="text" name="tempo_preparo" placeholder="Ex: 2.5 equivalem à 2:30" value="<?php echo $tempo_preparo ?>"></td>
							</tr>
							<tr>
								<td>Valor unitário: </td>
								<td><input class="cadastro_input" id="txtValorUnitario" type="text" name="valor_unitario" placeholder="Valor Unitário" value="<?php echo $valor_unitario ?>"></td>
							</tr>

							<tr>
								<td colspan="2"><h3 id="tr_ingredientes">Ingredientes</h3><div id="box_ingredientes">
										<div class="ingrediente" id="ingrediente">
											<div class="img_ingrediente" id="img_ingrediente0"></div>
											<select type="text" name="tipo_ingrediente" id="select_tipo_ingrediente0" class="select_tipo_ingrediente">

											</select>

											<select disabled class="select_ingrediente" id="select_ingrediente0">
												<option value="">Ingrediente</option>

											</select>

											<input class="txtQuantidade" id="txtQuantidade0" type="text" placeholder="Peso em gramas" readonly><span>g</span>
											<button class="btnRemove" id="btnRemove">
							...
							<tr>
								<td><input class="botoes_cadastro" id="btnInserir" type="button" name="submit" value="<?php echo $botao ?>"></td>
