...
<?php
	...
	require_once('php/crud_banner.php');
	...
	if(isset($_GET['modo'])){
		...
		if($modo == 'editar'){
			$modo = '?modo=atualizar';
			$_SESSION['banner_id'] = $_GET['id'];
			$array = Buscar($_SESSION['banner_id']);
			$nome = $array['nome'];
			$botao = 'Editar';
		}if($modo == 'excluir'){
			$_SESSION['banner_id'] = $_GET['id'];
			Excluir($_SESSION['banner_id']);
		}
	}
	...
	if(isset($_POST['submit'])){
		...
		//Se for uma atualização de registro...
			...
			Editar($_SESSION['banner_id'],$nome,$caminho_imagem,$imagem);
	...
	<div class="corpo">
		...
		<div class="conteudo">
			...
			<div class="principal">
				...
				<!-- Cadastro de Banners -->
				<form name="form_parceiro" method="post" enctype="multipart/form-data" action="cadastro_banner.php<?php echo $modo ?>">
