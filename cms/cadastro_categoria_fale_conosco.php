<?php
	...
	require_once('php/crud_categoria_fale_conosco.php');
  ...
  if(!isset($_SESSION)) {
	...
	if(isset($_GET['modo'])){
		...
		if($modo == 'editar'){
			$modo = '?modo=atualizar';
			$_SESSION['categoria_fale_conosco_id'] = $_GET['id'];
			$array = Buscar($_SESSION['categoria_fale_conosco_id']);
			$nome = $array['nome'];
			$botao = 'Editar';
		}if($modo == 'excluir'){
			$_SESSION['categoria_fale_conosco_id'] = $_GET['id'];
			Excluir($_SESSION['categoria_fale_conosco_id']);
		}
	}
	...
	if(isset($_POST['submit'])){
		...
		//Se for uma atualização de registro...
			...
			Editar($_SESSION['categoria_fale_conosco_id'],$nome);
...
<head>
	...
	<title>Cadastro de Categorias (Fale Conosco)</title>
	...
	<div class="corpo">
		...
		<div class="conteudo">
			...
			<div class="principal">
				...
				<!-- Cadastro de Categorias (Fale Conosco) -->
				<form name="form_parceiro" method="post" enctype="multipart/form-data" action="cadastro_categoria_fale_conosco.php<?php echo $modo ?>">
					<div class="cadastro_ingrediente">
						<div class="cadastro_ingrediente_titulo">
							<h3>Cadastro de categorias do Fale Conosco</h3>
						</div>
				...
				<div class="visualizacao_ingrediente">
					<div class="cadastro_ingrediente_titulo">
						<h3>Visualização de categorias do Fale Conosco</h3>
					</div>
					<table>
