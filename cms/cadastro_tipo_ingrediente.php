<?php
	...
	require_once('php/crud_tipo_ingrediente.php');
  ...
  if(!isset($_SESSION)) {
	...
	if(isset($_GET['modo'])){
		...
		if($modo == 'editar'){
			$modo = '?modo=atualizar';
			$_SESSION['tipo_ingrediente_id'] = $_GET['id'];
			$array = Buscar($_SESSION['tipo_ingrediente_id']);
			$nome_tipo_ingrediente = $array['nome'];
			$botao = 'Editar';
		}if($modo == 'excluir'){
			$_SESSION['tipo_ingrediente_id'] = $_GET['id'];
			Excluir($_SESSION['tipo_ingrediente_id']);
		}
	}
	...
	if(isset($_POST['submit'])){
		...
		$nome_tipo_ingrediente = $_POST['nome'];
		...
		if($modo == 'novo'){
			Inserir($nome_tipo_ingrediente);

		//Se for uma atualização de registro...
		}else if($modo == 'atualizar'){
			Editar($_SESSION['tipo_ingrediente_id'],$nome_tipo_ingrediente);
          ...
          <li class="menu_destacado_borda_esquerda">
			...
			<div class="principal">
				...
				<form name="form_tipo_ingrediente" method="post" enctype="multipart/form-data" action="cadastro_tipo_ingrediente.php<?php echo $modo ?>">
					<div class="cadastro_ingrediente">
						<div class="cadastro_ingrediente_titulo">
							<h3>Cadastro de Tipos de Ingrediente</h3>
						</div>
						<!-- Tabela inserida para bom posicionamento e estruturação dos itens -->
						<table>
							<tr>
								<td>Nome: </td>
								<td><input required class="cadastro_input" type="text" name="nome" placeholder="Nome" value="<?php echo $nome_tipo_ingrediente ?>"></td>
							</tr>
							<tr>
				...
				<div class="visualizacao_ingrediente">
					<div class="cadastro_ingrediente_titulo">
						<h3>Visualização de Tipos de Ingrediente</h3>
					</div>
					<table>
