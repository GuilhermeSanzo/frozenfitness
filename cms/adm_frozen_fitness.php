	...
	<div class="corpo">
		...
		<div class="conteudo">
			...
			<div class="principal">
				...
				<div class="box_secao">
					<a href="cadastro_fornecedor.php">
						...
						<div class="box_secao_secundaria">
							<ul>
								<li>Visualizar em Fornecedor</li>
								<li>Inserir em Fornecedor</li>
								<li>Editar em Fornecedor</li>
								<li>Cadastrar em Fornecedor</li>
							</ul>
						</div>
					</a>
				</div>
				<!-- Seção -->
				<div class="box_secao">
					<a href="cadastro_parceiros.php">
						<div class="box_secao_primaria">
							<img src="img/parceiro.png" alt="imagem">
							<h3>Parceiros</h3>
						</div>
						<div class="box_secao_secundaria">
							<ul>
								<li>Visualizar em Parceiros</li>
								<li>Inserir em Parceiros</li>
								<li>Editar em Parceiros</li>
								<li>Cadastrar em Parceiros</li>
							</ul>
						</div>
					</a>
				</div>
				...
				<div class="box_secao">
					<a href="cadastro_rel_ingrediente_fornecedor.php">
						<div class="box_secao_primaria">
							<img src="img/parceiro.png" alt="imagem">
							<h3>Rel. de Ingrediente e Fornecedor</h3>
						</div>
						<div class="box_secao_secundaria">
							<ul>
								<li>Visualizar em Relacionamento</li>
								<li>Inserir em Relacionamento</li>
								<li>Editar em Relacionamento</li>
								<li>Cadastrar em Relacionamento</li>
							</ul>
						</div>
					</a>
				</div>
