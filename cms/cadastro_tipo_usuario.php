<?php
	...
	require_once('php/crud_tipo_usuario.php');
  ...
  if(!isset($_SESSION)) {
	...
	if(isset($_GET['modo'])){
		...
		if($modo == 'editar'){
			$modo = '?modo=atualizar';
			$_SESSION['tipo_cadastro_id'] = $_GET['id'];
			$array = Buscar($_SESSION['tipo_cadastro_id']);
			$nome = $array['nome'];
			$botao = 'Editar';
		}if($modo == 'excluir'){
			$_SESSION['tipo_cadastro_id'] = $_GET['id'];
			Excluir($_SESSION['tipo_cadastro_id']);
		}
	}
	...
	if(isset($_POST['submit'])){
		...
		//Se for uma atualização de registro...
			...
			Editar($_SESSION['tipo_cadastro_id'],$nome);
	...
	<div class="corpo">
		...
		<div class="conteudo">
			...
			<div class="principal">
				...
				<form name="form_tipo_usuario" method="post" enctype="multipart/form-data" action="cadastro_tipo_usuario.php<?php echo $modo ?>">
					<div class="cadastro_ingrediente">
						<div class="cadastro_ingrediente_titulo">
							<h3>Cadastro de Tipos de Usuário</h3>
						</div>
				...
				<!-- Visualização de Tipos de Usuário -->
				<div class="visualizacao_ingrediente">
					<div class="cadastro_ingrediente_titulo">
						<h3>Visualização de Tipos de Usuário</h3>
					</div>
					<table>
