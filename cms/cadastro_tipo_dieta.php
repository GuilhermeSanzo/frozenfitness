<?php
	...
	require_once('php/crud_tipo_dieta.php');
  ...
  if(!isset($_SESSION)) {
	...
	if(isset($_GET['modo'])){
		...
		if($modo == 'editar'){
			$modo = '?modo=atualizar';
			$_SESSION['tipo_dieta_id'] = $_GET['id'];
			$array = Buscar($_SESSION['tipo_dieta_id']);
			$nome = $array['nome'];
			$botao = 'Editar';
		}if($modo == 'excluir'){
			$_SESSION['tipo_dieta_id'] = $_GET['id'];
			Excluir($_SESSION['tipo_dieta_id']);
		}
	}
	...
	if(isset($_POST['submit'])){
		...
		if($modo == 'novo'){
			Inserir($nome,$caminho_imagem,$imagem);

		//Se for uma atualização de registro...
		}else if($modo == 'atualizar'){
			Editar($_SESSION['tipo_dieta_id'],$nome,$caminho_imagem,$imagem);
...
<head>
	...
	<link href="css/tipo_dieta.css" rel="stylesheet"/>
		...
		<div class="conteudo">
          ...
          <li class="menu_destacado_borda_esquerda">
			...
			<div class="principal">
				...
				<!-- Cadastro de Tipos de Dieta -->
				<form name="form_parceiro" method="post" enctype="multipart/form-data" action="cadastro_tipo_dieta.php<?php echo $modo ?>">
					<div class="cadastro_ingrediente">
						<div class="cadastro_ingrediente_titulo">
							<h3>Cadastro de Tipos de Dieta</h3>
						</div>
				...
				<!-- Visualização de Tipos de Dieta -->
				<div class="visualizacao_ingrediente">
					<div class="cadastro_ingrediente_titulo">
						<h3>Visualização de Tipos de Dieta</h3>
					</div>
					<table>
