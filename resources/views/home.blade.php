                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    @if(session()->has('cart.' . $meal->id))
                                        <a href="{{ route('cart.index') }}" class="bg-green-600 text-white px-4 py-2 rounded-xl font-bold flex items-center gap-2 hover:bg-green-700 transition">
                                            <span>In Cart</span>
                                    ...
                                    @else
                                        <form action="{{ route('cart.add') }}" method="POST">
                                            ...
                                            <button type="submit" class="bg-green-100 text-green-700 p-3 rounded-xl hover:bg-green-600 hover:text-white transition-colors duration-200">
