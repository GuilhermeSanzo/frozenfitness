            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-3xl border border-gray-100 hover:shadow-xl transition-all duration-300 group">
                    <div class="p-8">
                        ...
                        <a href="#" class="inline-flex items-center justify-center w-full py-3 px-4 bg-gray-50 text-gray-700 font-bold rounded-xl hover:bg-green-600 hover:text-white transition-all duration-200">
                            Manage Meals
                        </a>
                    </div>
                </div>
