...
CREATE TABLE `prato` (
  ...
  `tipo_usuario_id` int(11) NOT NULL,
  `tempo_preparo` double(10,2) NOT NULL,
  `descricao` text,
...
INSERT INTO `prato` VALUES (6,'Prato de Arroz, Feijao e Bife','2016-10-31',18.00,'../img/1.png',2,4.00,NULL),(7,'Filé de Frango a Milanesa com Bróculis','2016-10-24',19.20,'../img/2.jpg',2,2.50,NULL),(8,'Sopa de Batata doce','2016-10-31',20.50,'../img/sopa_batata_doce.jpg',2,3.00,NULL),(9,'Porção de Cereal de milho','2016-10-31',15.80,'../img/cereais.jpg',2,2.00,NULL),(10,'Porção de Corvina com arroz','2016-10-31',36.00,'../img/corvina.jpg',2,3.00,NULL),(11,'Salada de Beterraba com Nozes','2016-10-31',15.50,'../img/salada_beterraba_nozes.jpg',2,1.00,NULL);
...
-- Dump completed on 2016-10-13 16:43:31
