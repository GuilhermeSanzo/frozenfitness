...
INSERT INTO `caminhao` (`caminhao_id`, `placa`, `latitude`, `longitude`, `transportadora_id`, `motorista_id`) VALUES
(1, 'RFE-7410', 21.50703349, 55.41190810, 2, 1),
(2, 'GTR-6412', 55.41190810, 21.50703349, 3, 2),
(3, 'UYG-7089', 21.50703349, 55.41190810, 1, 3),
(4, 'bcd-127', NULL, NULL, 7, 3),
(5, 'BCD-0127', NULL, NULL, 8, 2);
...
(36, 'Proclamação!', 2, NULL, 'Caracteres especiais são importantes!', 2, NULL);
...
(2, 'Rua', 'Ruanda', 321, '07892-234', 'Nova Orleans', 'Recife', 'Pernambuco', 2),
(4, 'Rua', 'Serrinhas', 789, '04562-684', 'Perus', 'Salvador', 'Bahia', 2),
(6, 'Rua', 'Gueto', 531, '07896-324', 'Vila Olimpia', 'Florianópolis', 'Santa Catarina', 2),
(7, 'Rua', 'Meiota', 124, '03214-234', 'Rosevelt', 'Rio Branco', 'Acre', 2),
(8, 'Rua', 'Presidente Carlão Ban', 631, '04567-321', 'Olaria do Nino', 'Macapá', 'Amapá', 2),
(9, 'Rua', 'Runaldo', 123, '06661-340', 'Jardins', 'Porto Velho', 'Rondônia', 2),
(23, 'Rua', 'Compra', 123, '06662-124', 'Barril', 'São Paulo', 'São Paulo', 2),
(25, 'Quilômetro', 'Compra', 123, '06662-124', 'Barril', 'São Paulo', 'São Paulo', 1),
(26, 'Rua', 'Runeira', 123, '06623480', 'Barrillo', 'Cidadela', 'Pernambuco', 2),
(27, 'Rua', 'Da Tristeza', 666, '06666-667', 'da Amargura', 'Decepções', 'Rio Grande do Norte', 2),
(28, 'Avenida', 'Teste', 123, '06604-130', 'Barril', 'Castelo', 'São Paulo', 2),
(29, 'Rua', 'Sônia Maria F. de Andrade', 85, '06604-130', 'Jardim Novo Horizonte', 'Jandira', 'SP', 2),
(30, 'Alameda', NULL, 12345, '43534-656', '62324-687', 'Cidadela', 'Santa Catarina', 1),
(31, 'Rua', 'Maçanetas', 123, '06579-884', 'Barril', 'Cidadela', 'Estadão', 1),
(32, 'Rua', 'Rua1', 1231, 'Mapado1', '09032-632', 'Marcada1', 'Estatuto1', 1),
(33, 'Rua', 'Seatloft', 123, '06547-893', 'Windows', 'Micro', 'Soft', 1),
(34, 'Rua', 'Rua1', 1233, '52121-212', 'teste1', 'teste1', 'teste1', 1),
...
(6, 'Alphabet', 'XYZ', '6547898', 8),
(7, 'gss inc.', 'guilherme ss', '6547897', 9),
...
(14, 'teste1', 'teste1', '12.334.568/9086-52', 30);
...
(12, 'teste1', 'img/freddie_mercury_cartoon.jpg', '(13) 3234-34343', 35, NULL);
...
(123, 8, NULL, 1, 180.40, '2016-11-17', '2016-11-25'),
(124, 2, NULL, 1, 25.80, '2016-11-01', '2016-11-21'),
(125, 8, NULL, 1, 26.40, '2016-11-18', '2016-11-21'),
...
(2, 'Guilherme', 'Souza', 'guilherme@email.com', 'emrehliug', 1, '1997-05-16', '789.456.123-05', '(11)4189-2489', 79.00, 1.98, 4, 2, 'img/usuario/G-hacker-boy_01.jpg', 2),
(4, 'Samuel', 'Rocha', 'samuel.rocha.tj@outlook.com', '1234', 1, '1998-03-02', '446.442.348-50', '11961851582', 68.20, 1.68, 2, 2, 'img/usuario/cabeca.gif', 29),
(5, 'Miguel', 'Pitbull', 'miguelhenrique34@gmail.com', '1234', 1, '1996-03-25', '434.475.128-06', '11953023734', 90.00, 1.85, 1, 2, 'img/usuario/img_user.png', 5),
(6, 'Thalles', 'Vantini', 'thalles@email.com', '1234', 1, '1990-05-11', '489.658.912-23', '(11)4002-8922', 79.00, 1.94, 4, 2, 'img/usuario/img_user.png', 6),
...
(9, 'Administrativo', '', 'administrativo@email.com', '1234', 1, '1990-08-12', '654.789.123-78', '(11)4567-1234', 70.20, 2.80, 3, 3, 'img/usuario/img_user.png', 9),
(10, 'Marketing', '', 'marketing@email.com', '1234', 1, '1942-09-18', '465.547.987-82', '(11)4568-2314', 60.00, 1.80, 4, 4, 'img/usuario/img_user.png', NULL),
(11, 'Diretoria', '', 'diretoria@email.com', '1234', 1, '1940-08-02', '456.987.321-15', '(11)4567-3214', 60.20, 1.65, 4, 5, 'img/usuario/img_user.png', 0),
(12, 'Gerenciador', 'Usuários\r\n', 'gerenciador@email.com', '1234', 1, '1942-05-12', '456.987.320-15', '(11)4569-3248', 70.20, 1.72, 4, 6, 'img/usuario/img_user.png', 0),
...
--
ALTER TABLE `dieta`
  MODIFY `dieta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
...
--
ALTER TABLE `parceiro`
  MODIFY `parceiro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `pedido`
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
--
...
--
ALTER TABLE `rel_dieta_pedido`
  MODIFY `rel_dieta_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
...
--
ALTER TABLE `rel_prato_pedido`
  MODIFY `rel_prato_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
--
...
--
ALTER TABLE `rel_status_pedido`
  MODIFY `rel_status_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
