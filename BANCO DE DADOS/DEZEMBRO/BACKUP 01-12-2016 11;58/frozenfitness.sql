...
--
-- Host: 127.0.0.1    Database: ypfrozen
-- ------------------------------------------------------
...
INSERT INTO `aprovacao` VALUES (1,'Aguardando aprovação'),(2,'Aprovado'),(3,'Não aprovado');
...
INSERT INTO `banner` VALUES (1,'bannerzao','img/banner1.png'),(3,'bannerlinho','img/banner3.png'),(4,'bannerlazo','img/banner4.png');
...
CREATE TABLE `caminhao` (
  ...
  `estado_atuacao` varchar(2) DEFAULT NULL,
...
INSERT INTO `caminhao` VALUES (1,'RFE-7410',-23.00000000,-46.00000000,1,1,'26'),(2,'BCD-0127',55.41190810,21.50703349,1,2,'26'),(3,'UYG-7089',21.50703349,55.41190810,1,3,'26'),(4,'abc-1234',NULL,NULL,5,3,'10'),(5,'BCD-0127',NULL,NULL,8,2,'27'),(9,'CBO-1234',NULL,NULL,5,1,'26'),(10,'abc-1234',NULL,NULL,5,3,'4');
/*!40000 ALTER TABLE `caminhao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `categoria_artigo`
--
...
CREATE TABLE `categoria_artigo` (
  ...
  `nome` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`categoria_artigo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `categoria_artigo` WRITE;
/*!40000 ALTER TABLE `categoria_artigo` DISABLE KEYS */;
INSERT INTO `categoria_artigo` VALUES (1,'Dieta'),(2,'Treino'),(3,'Suplementação'),(4,'Aeróbico'),(5,'Perda de Peso'),(6,'Motivacional');
/*!40000 ALTER TABLE `categoria_artigo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `categoria_fale_conosco`
--

DROP TABLE IF EXISTS `categoria_fale_conosco`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `categoria_fale_conosco`
--

LOCK TABLES `categoria_fale_conosco` WRITE;
/*!40000 ALTER TABLE `categoria_fale_conosco` DISABLE KEYS */;
INSERT INTO `categoria_fale_conosco` VALUES (1,'Sugestão'),(2,'Reclamação'),(3,'Elogio'),(6,'Dúvidas'),(7,'Outros');
/*!40000 ALTER TABLE `categoria_fale_conosco` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `dieta` VALUES (35,'teste',1,NULL,'teste',2,NULL),(36,'teste44',1,NULL,'testando',2,NULL);
...
INSERT INTO `endereco` VALUES (2,'Rua','Ruanda',321,'07892-234','Nova Orleans','Recife','PE',2),(4,'Rua','Serrinhas',789,'04562-684','Perus','Salvador','BA',2),(6,'Rua','Gueto',531,'07896-324','Vila Olimpia','Florianópolis','SC',2),(7,'Rua','Meiota',124,'03214-234','Rosevelt','Rio Branco','AC',2),(8,'Rua','Rog Soares da Silva',631,'06730-000','Tijuco Preto','Vargem Grande Paulista','SP',2),(9,'Rua','Runaldo',123,'06661-340','Jardins','Porto Velho','RO',2),(23,'Rua','Compra',123,'06662-124','Barril','São Paulo','SP',2),(25,'Quilômetro','Compra',123,'06662-124','Barril','São Paulo','SP',1),(26,'Rua','Runeira',123,'06623480','Barrillo','Cidadela','PE',2),(27,'Rua','Da Tristeza',666,'06666-667','da Amargura','Decepções','RN',2),(28,'Avenida','Teste',123,'06604-130','Barril','Castelo','SP',2),(29,'Rua','Sônia Maria F. de Andrade',85,'06604-130','Jardim Novo Horizonte','Jandira','SP',2),(30,'Alameda','Alamedaasda',12345,'43534-656','62324-687','Cidadela','SC',1),(31,NULL,'asd',6,'12346-546','54645-464','tal','SP',1),(32,NULL,'dasdasdasd',4654654,'44654-656','asdasdasd','asdasd','SP',1),(33,NULL,'asddasdas',654654,'65465-465','ASDASDAS','São Paulo','SP',1),(34,NULL,'Av. João Paulo I',1795,'06816-550','Jardim dos Oliveiras','Embu das Artes ','SP',1),(35,NULL,'R. Silos',32,'02335-060','Água Fria','São Paulo','SP',1),(36,NULL,'Rua Humaitá',1937,'17205-120','Vila Carvalho','Jaú','SP',1),(37,NULL,'Avenida José Barbosa de Siqueira',531,'06172-000','Jardim Roberto','Osasco','SP',1),(38,NULL,'Rod. José Simões Louro Júnior,',42582,'06900-000','Itararé','São Paulo','SP',1),(39,NULL,'Av. Maria Coelho Aguiar',215,'05118-100','Jardim São Luís','São Paulo','SP',1),(40,NULL,'Rua Martins Gonçalves de Souza',346,'37640-000','Bairro dos Pires','Extrema','MG',1),(41,NULL,'teste',2132,'21313-213','asdkjaskljdkla','daklsjdaj','SP',1),(42,'Alameda','Silos',13,'02335-060','Água Branca','São Paulo','SP',2),(43,'Rua','Sônia Maria F. de Andrade',85,'06604-130','Jardim Novo Horizonte','Jandira','RJ',2);
...
INSERT INTO `estoque` VALUES (1,3,123,1,'2016-11-29 16:06:07','teste');
...
INSERT INTO `faleconosco` VALUES (4,'guilherme','guilherme@email.com','oloco','mensagem muito louca',3,1),(6,'Joselito Alves','joselito@email.com','Quero meu café','Bota um cafezinho para nós aí po, não custa nada.\r\nNa verdade custa, mas libera aeeee!!!\r\n',2,1),(27,'teste','teste@teste','teste','teste',1,1),(28,'falando','falando@conosco','falando','falando conosco',7,1);
...
INSERT INTO `fornecedor` VALUES (16,'teste','tesando','12.314.654/6546-54',41);
/*!40000 ALTER TABLE `fornecedor` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `horario_do_dia`
--
...
LOCK TABLES `horario_do_dia` WRITE;
/*!40000 ALTER TABLE `horario_do_dia` DISABLE KEYS */;
INSERT INTO `horario_do_dia` VALUES (1,'Café da Manhã'),(2,'Almoço'),(3,'Jantar');
...
INSERT INTO `ingrediente` VALUES (3,'Arroz Branco',14,120,1,'img/arroz.jpg'),(4,'Feijao',14,150,1,'img/feijao.jpg'),(5,'Peixe',14,90,2,'img/Peixe_Ingrediente.jpg'),(6,'Carne de Boi',14,100,3,'img/carne.jpg'),(7,'Molusco',14,100,4,'img/molusco.jpg'),(8,'Macarrão',14,100,6,'img/macarrao.jpg'),(9,'Batata',14,100,9,'img/batata.png'),(11,'Tomate',14,350,10,'img/tomate.jpg'),(12,'Filé de Frango',14,360,2,'img/file_frango.jpg'),(13,'Batata Doce',14,150,9,'img/batata_doce.jpg'),(14,'Salsinha',14,30,8,'img/salsinha.jpg'),(15,'Milho',14,100,1,'img/milho.png'),(16,'Beterraba',14,60,9,'img/beterraba.jpg'),(17,'Noz',14,20,10,'img/nozes.jpg'),(19,'Mandioquinha',14,60,9,'img/mandioquinha_do_dodo.jpg'),(20,'Espinafre',14,5,8,'img/espinafre.jpg'),(21,'Cebola',14,10,8,'img/cebola.jpg'),(22,'Alho',14,10,9,'img/alho.jpg'),(23,'Pimenta Calabresa',14,5,1,'img/pimenta_calabresa.jpg'),(24,'Sal',14,2,1,'img/sal.jpg'),(25,'Clara de ovo',14,30,14,'img/clara_de_ovo.jpg'),(26,'Açucar',14,90,1,'img/acucar.jpg'),(27,'Canela',14,50,1,'img/canela.jpg'),(28,'Banana',14,20,10,'img/banana.jpg'),(29,'Aveia',14,10,1,'img/aveia.jpg');
...
INSERT INTO `motorista` VALUES (1,'lucas@roberto.com','123','Lucas Roberto dos Santos Editado','1990-10-04','52.166.782-3','011953023734'),(2,'muel.casado@gmail.com','40bd001563085fc35165329ea1ff5c5ecbdbbeef','Samuel Rocha da Silva','1996-03-06','65.777.969-5','011983486367'),(3,'tadas.godoi@outlook.com','123','Tadao Godoi Penismuxa','1994-02-15','89.412.586-9','011945697739'),(4,'thalles@teste.com','123','Thalles Roberto Editado','2016-10-17','0002200','945455454');
...
INSERT INTO `operacao` VALUES (1,'Adicionar'),(3,'Remover');
...
INSERT INTO `parceiro` VALUES (6,'Suplementos Alimentares - Espartanos','img/Espartanos_Parceiros.jpg','(11) 3384-0500',24,NULL),(7,'CentralFit','img/CentralFit_Parceiros.png','(11) 3615-2503',25,NULL),(11,'Probiótica Laboratórios','img/probiotica_logo.jpg','(11) 4785-3322',34,NULL),(12,'Espartanos Suplementos','img/espartanos_logo.png','(11) 3384-0500',35,NULL),(13,'Corpo Ideal','img/corpoideal_logo.jpg','(14) 3624-1425',36,NULL),(14,'Sadia S. A.','img/sadia_logo.jpg','(11) 3609-1212',37,NULL),(15,'Integramédica','img/integral_logo.png','(11) 4662-7300',38,NULL),(16,'JBS S. A.','img/jbs_logo.png','(11) 3014-0207',39,NULL),(17,'Centauro','img/centauro_logo.jpg','(11) 4004-6006',40,NULL);
...
CREATE TABLE `pedido` (
  ...
  `total_pedido` double(10,2) DEFAULT NULL,
  `dt_entrega_solic` date DEFAULT NULL,
...
INSERT INTO `pedido` VALUES (117,4,2,6,344.00,'2016-11-21'),(118,4,1,6,25.80,'2016-11-19'),(119,4,3,6,844.88,'2016-11-25'),(121,4,9,6,25.80,'2016-11-21'),(126,5,9,6,26.40,'2016-11-21'),(127,4,9,6,125.64,'2016-11-21'),(128,8,1,6,96.30,'2016-11-21'),(129,8,1,6,125.64,'2016-11-23'),(130,8,1,6,37.36,'2017-02-28'),(131,8,1,6,138.20,'2016-11-21'),(132,8,1,6,35.20,'2016-12-08'),(135,4,NULL,1,26.40,'2016-12-02'),(136,16,NULL,1,26.40,'2016-12-02');
...
INSERT INTO `prato` VALUES (7,'Filé de Frango a Milanesa com Bróculis','1',19.20,'../img/2.jpg',2,2,'Prato muito gostoso, perfeito para quem quer perder peso',2,17,3,'2016-11-04 15:18:17'),(8,'Sopa de Batata doce','1',20.50,'../img/sopa_batata_doce.jpg',2,3,'Prato muito sadio, perfeito para quem quer perder peso',2,4,2,'2016-11-04 15:18:17'),(9,'Porção de Cereal de milho','1',15.80,'../img/cereais.jpg',2,2,'Prato muito atrativo, perfeito para quem quer perder peso',2,1,2,'2016-11-04 15:18:17'),(11,'Salada de Beterraba com Nozes','1',15.50,'../img/salada_beterraba_nozes.jpg',2,1,'Prato nutritivo, perfeito para quem quer perder peso',2,4,2,'2016-11-04 15:18:17'),(21,'Macarrão Integral com Carne Desfiada','1',12.00,'../img/MacarraoCarneDesfiada_Pratos.jpg',2,1,'Prato nutritivo, perfeito para quem quer perder peso',2,1,2,'2016-11-04 15:18:17'),(28,'Sopa de mandioquinha com espinafre','3',14.99,'../img/sopa_mandioquinha.jpg',2,1,'Sopa de mandioquinha com espinafre ',6,NULL,2,NULL),(29,'Panqueca proteica, geléia diet','3',19.95,'../img/panqueca.jpg',2,2,'Sobremesa de panqueca proteica com geléia diet, ideal para crianças que gostam de comer doces diarimente. ',6,NULL,2,NULL);
...
INSERT INTO `promocao` VALUES (1,'Promoção de Verão',20.00),(2,'Promoção de Inverno',20.00),(4,'Black friday',50.00);
/*!40000 ALTER TABLE `promocao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_cliente_endereco`
--
...
CREATE TABLE `rel_dieta_pedido` (
  `rel_dieta_pedido_id` int(11) NOT NULL AUTO_INCREMENT,
  `dieta_id` int(11) DEFAULT NULL,
  `qtde` int(11) DEFAULT NULL,
  `pedido_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`rel_dieta_pedido_id`)
...
LOCK TABLES `rel_dieta_pedido` WRITE;
/*!40000 ALTER TABLE `rel_dieta_pedido` DISABLE KEYS */;
INSERT INTO `rel_dieta_pedido` VALUES (54,35,5,117),(55,35,11,119),(56,35,1,120),(57,36,1,127),(58,35,1,128),(59,36,1,129),(60,36,1,131);
/*!40000 ALTER TABLE `rel_dieta_pedido` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_dieta_prato`
--
...
LOCK TABLES `rel_dieta_prato` WRITE;
/*!40000 ALTER TABLE `rel_dieta_prato` DISABLE KEYS */;
INSERT INTO `rel_dieta_prato` VALUES (37,1,1,14,35),(38,2,2,9,35),(39,1,1,14,36),(40,2,2,10,36),(41,3,3,11,36),(43,2,3,7,35);
/*!40000 ALTER TABLE `rel_dieta_prato` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_ingrediente_fornecedor`
--
...
LOCK TABLES `rel_ingrediente_fornecedor` WRITE;
/*!40000 ALTER TABLE `rel_ingrediente_fornecedor` DISABLE KEYS */;
/*!40000 ALTER TABLE `rel_ingrediente_fornecedor` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_pedido_transportadora`
--

DROP TABLE IF EXISTS `rel_pedido_transportadora`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rel_pedido_transportadora` (
  `rel_pedido_transportadora_id` int(11) NOT NULL AUTO_INCREMENT,
  `pedido_id` int(11) DEFAULT NULL,
  `transportadora_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`rel_pedido_transportadora_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rel_pedido_transportadora`
--

LOCK TABLES `rel_pedido_transportadora` WRITE;
/*!40000 ALTER TABLE `rel_pedido_transportadora` DISABLE KEYS */;
INSERT INTO `rel_pedido_transportadora` VALUES (1,118,1),(2,117,1),(3,119,1),(4,121,5),(5,126,5),(6,127,5),(7,128,1),(8,131,1),(9,129,1),(10,130,1),(11,132,1);
/*!40000 ALTER TABLE `rel_pedido_transportadora` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_prato_ingrediente`
--
...
LOCK TABLES `rel_prato_ingrediente` WRITE;
/*!40000 ALTER TABLE `rel_prato_ingrediente` DISABLE KEYS */;
INSERT INTO `rel_prato_ingrediente` VALUES (14,301,3,7),(15,600,12,7),(17,130,11,7),(18,200,13,8),(19,160,14,8),(23,100,17,11),(24,201,16,11),(40,300,15,9),(48,200,8,21),(49,200,6,21),(51,500,8,24),(66,200,19,28),(67,50,20,28),(68,5,24,28),(69,2,23,28),(70,5,22,28),(71,10,26,29),(72,10,27,29),(73,30,29,29),(74,70,28,29),(75,30,25,29);
/*!40000 ALTER TABLE `rel_prato_ingrediente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_prato_pedido`
--

DROP TABLE IF EXISTS `rel_prato_pedido`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rel_prato_pedido` (
  `rel_prato_pedido_id` int(11) NOT NULL AUTO_INCREMENT,
  `prato_id` int(11) DEFAULT NULL,
  `qtde` int(11) DEFAULT NULL,
  `pedido_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`rel_prato_pedido_id`)
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rel_prato_pedido`
--

LOCK TABLES `rel_prato_pedido` WRITE;
/*!40000 ALTER TABLE `rel_prato_pedido` DISABLE KEYS */;
INSERT INTO `rel_prato_pedido` VALUES (128,25,5,117),(129,9,2,118),(130,7,3,119),(131,8,10,119),(132,9,1,121),(133,7,1,122),(134,7,1,123),(135,7,1,124),(136,9,1,125),(137,8,1,126),(138,9,1,127),(139,21,2,128),(140,11,3,128),(141,9,1,129),(142,21,1,130),(143,7,1,130),(144,10,1,131),(145,10,1,132),(146,11,2,133),(147,21,2,133),(148,9,2,133),(149,11,2,134),(150,21,2,134),(151,9,2,134),(152,8,1,135),(153,8,1,136);
/*!40000 ALTER TABLE `rel_prato_pedido` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_prato_promocao`
--

DROP TABLE IF EXISTS `rel_prato_promocao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rel_prato_promocao` (
  `rel_prato_promocao_id` int(11) NOT NULL AUTO_INCREMENT,
  `prato_id` int(11) DEFAULT NULL,
  `promocao_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`rel_prato_promocao_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `rel_prato_promocao`
--

LOCK TABLES `rel_prato_promocao` WRITE;
/*!40000 ALTER TABLE `rel_prato_promocao` DISABLE KEYS */;
INSERT INTO `rel_prato_promocao` VALUES (1,7,1),(2,8,1),(3,9,1),(4,10,3);
/*!40000 ALTER TABLE `rel_prato_promocao` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rel_status_pedido`
--
...
LOCK TABLES `rel_status_pedido` WRITE;
/*!40000 ALTER TABLE `rel_status_pedido` DISABLE KEYS */;
INSERT INTO `rel_status_pedido` VALUES (9,'2016-11-16 19:13:36',1,117),(15,'2016-11-16 21:45:20',1,118),(17,'2016-11-16 22:16:30',2,117),(18,'2016-11-16 22:16:33',2,118),(19,'2016-11-16 22:18:50',3,117),(20,'2016-11-16 22:18:53',3,118),(21,'2016-11-16 22:19:52',4,117),(22,'2016-11-16 22:19:56',4,118),(23,'2016-11-17 00:30:14',5,118),(24,'2016-11-17 00:30:19',5,117),(25,'2016-11-18 02:03:11',6,118),(26,'2016-11-18 02:05:00',6,117),(27,'2016-11-18 02:07:08',1,119),(28,'2016-11-18 02:12:44',2,119),(29,'2016-11-18 02:12:53',3,119),(30,'2016-11-18 02:13:11',4,119),(31,'2016-11-18 02:13:29',5,119),(32,'2016-11-18 02:13:46',6,119),(34,'2016-11-18 13:29:11',1,120),(35,'2016-11-18 13:31:28',2,120),(36,'2016-11-18 13:33:22',1,121),(37,'2016-11-18 13:36:55',2,121),(38,'2016-11-18 13:37:10',3,121),(39,'2016-11-18 13:37:21',4,121),(40,'2016-11-18 13:37:41',5,121),(41,'2016-11-18 13:39:25',6,121),(42,'2016-11-18 14:22:06',1,122),(43,'2016-11-18 14:23:21',1,123),(44,'2016-11-18 14:23:50',1,124),(45,'2016-11-18 14:28:27',1,125),(46,'2016-11-18 14:28:48',1,126),(47,'2016-11-18 14:50:54',1,127),(48,'2016-11-18 14:52:05',2,126),(49,'2016-11-18 14:52:09',2,127),(50,'2016-11-18 14:52:17',3,126),(51,'2016-11-18 14:52:21',3,127),(52,'2016-11-18 14:52:27',4,126),(53,'2016-11-18 14:52:32',4,127),(54,'2016-11-18 14:52:44',5,126),(55,'2016-11-18 14:52:49',5,127),(56,'2016-11-18 14:53:03',6,127),(57,'2016-11-18 14:53:16',6,126),(58,'2016-11-18 15:09:49',1,128),(59,'2016-11-18 15:10:43',1,129),(60,'2016-11-18 15:11:51',1,130),(61,'2016-11-18 15:12:48',1,131),(62,'2016-11-18 15:13:40',2,128),(63,'2016-11-18 15:13:44',2,129),(64,'2016-11-18 15:13:47',2,130),(65,'2016-11-18 15:13:50',2,131),(66,'2016-11-18 15:14:00',3,129),(67,'2016-11-18 15:14:04',3,128),(68,'2016-11-18 15:14:06',3,130),(69,'2016-11-18 15:14:09',3,131),(70,'2016-11-18 15:14:16',4,128),(71,'2016-11-18 15:14:19',4,129),(72,'2016-11-18 15:14:23',4,130),(73,'2016-11-18 15:14:26',4,131),(74,'2016-11-18 15:14:34',5,128),(75,'2016-11-18 15:14:38',5,131),(76,'2016-11-18 15:14:41',5,129),(77,'2016-11-18 15:14:43',5,130),(78,'2016-11-18 15:19:58',1,132),(79,'2016-11-18 15:27:03',6,128),(80,'2016-11-18 15:27:08',6,129),(81,'2016-11-18 15:27:28',6,131),(82,'2016-11-18 15:27:36',6,130),(83,'2016-11-29 19:12:21',2,132),(84,'2016-11-29 19:12:34',3,132),(85,'2016-11-29 19:12:46',4,132),(86,'2016-11-29 19:12:57',5,132),(87,'2016-11-29 19:13:09',6,132),(88,'2016-11-29 20:29:18',1,133),(89,'2016-11-29 20:30:13',1,134),(90,'2016-11-29 20:32:46',1,135),(91,'2016-11-29 20:33:18',1,136);
...
INSERT INTO `status` VALUES (1,'Aguardando Pagamento'),(2,'Aguardando Separação de Ingredientes'),(3,'Aguardando Preparo'),(4,'Aguardando Envio para Transportadora'),(5,'Pronto para envio'),(6,'Á Caminho'),(7,'Entregue');
...
LOCK TABLES `tipo_cadastro` WRITE;
...
INSERT INTO `tipo_dieta` VALUES (1,'Emagrecimento','img/emagrecimento_icon.png','#5F4ACD'),(2,'Hipertrofia','img/hipertrofia_icon.png','#34ABCF'),(3,'Kids','img/','#C7E5F9');
...
INSERT INTO `tipo_endereco` VALUES (1,'Parceiro'),(2,'Cliente'),(3,'Fornecedor');
...
CREATE TABLE `tipo_ingrediente` (
  `tipo_ingrediente_id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(45) DEFAULT NULL,
...
INSERT INTO `tipo_ingrediente` VALUES (1,'Grãos'),(2,'Carne Branca'),(3,'Carne Vermelha'),(4,'Frutos do Mar'),(6,'Massa'),(7,'Ácido Sulfúrico'),(8,'Verdura'),(9,'Legume'),(10,'Fruta'),(14,'Ovo');
...
INSERT INTO `tipo_usuario` VALUES (1,'Cliente'),(2,'Administrador do Sistema'),(3,'Administrativo'),(4,'Marketing'),(5,'Diretoria'),(6,'Gerenciador de Usuários'),(7,'SAC');
...
INSERT INTO `transportadora` VALUES (1,'123','testando','qualquer','456'),(2,'Lucas Roberto 2','456','Teste 2','0'),(3,'teste','456','teste 3','0'),(5,'123','teste','testando','456'),(7,'00.094.549/0038-80','Tadeo Santoro','Tadas Ltda','(11) 4143-7784'),(8,'00.354.519/4031-50','Waffer SA','Waffer SA','(13) 4343-7894'),(9,'123','teste','testando','456'),(11,'789','testando','estouaqui','456');
...
INSERT INTO `unidade` VALUES (14,'grama','g'),(15,'unidade','unid'),(20,'kilograma','kg'),(22,'litro','l'),(23,'mililitro','ml'),(24,'miligrama','mg'),(26,'tonelada','ton');
...
INSERT INTO `usuario` VALUES (2,'Guilherme','Souza','guilherme@email.com','emrehliug',1,'1997-05-16','789.456.123-05','(11)4189-2489',79.00,1.98,4,2,'img/usuario/G-hacker-boy_01.jpg',2),(4,'Samuel','Rocha','samuel.rocha.tj@outlook.com','1234',1,'1998-03-02','446.442.348-50','11961851582',68.20,1.68,2,2,'img/usuario/cliente.png',29),(5,'Miguel','Pitbull','miguelhenrique34@gmail.com','1234',1,'1996-03-25','434.475.128-06','11953023734',90.00,1.85,1,2,'img/usuario/img_user.png',42),(6,'Thalles','Vantini','thalles@email.com','1234',1,'1990-05-11','489.658.912-23','(11)4002-8922',79.00,1.94,4,2,'img/usuario/img_user.png',6),(7,'Lucas','Roberto','lucas@email.com','1234',1,'1988-08-08',NULL,NULL,NULL,NULL,NULL,2,'img/usuario/img_user.png',7),(8,'Cliente','1','cliente@email.com','1234',1,'1991-08-12','156.987.123-12','(21)4561-3214',60.20,1.82,2,1,'img/usuario/img_user.png',8),(9,'Administrativo','','administrativo@email.com','1234',1,'1990-08-12','654.789.123-78','(11)4567-1234',70.20,2.80,3,3,'img/usuario/img_user.png',9),(10,'Marketing','','marketing@email.com','1234',1,'1942-09-18','465.547.987-82','(11)4568-2314',60.00,1.80,4,4,'img/usuario/img_user.png',NULL),(11,'Diretoria','','diretoria@email.com','1234',1,'1940-08-02','456.987.321-15','(11)4567-3214',60.20,1.65,4,5,'img/usuario/img_user.png',0),(12,'Gerenciador','Usuários\r\n','gerenciador@email.com','1234',1,'1942-05-12','456.987.320-15','(11)4569-3248',70.20,1.72,4,6,'img/usuario/img_user.png',0),(13,'SAC1','','sac1@email.com','1234',0,'1982-07-03','654.706.984-324','(12)4896-3247',60.80,1.71,2,7,'img/batata.png',NULL),(14,'Isadora','Pinto de assis','isadora@email.com','252525',0,'1996-03-25','111.111.111-11','(22)2222-22222',60.80,60.50,1,1,'img/usuario/img_user.png',NULL),(15,NULL,NULL,NULL,NULL,NULL,'0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,'img/usuario/img_user.png',NULL),(16,'Vitória','Rocha da silva','vitoria123ayuzawa@gmail.com','010203',2,'2001-10-05','501.688.628-83','(11)9754-87161',61.00,1.57,2,1,NULL,43);
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'ypfrozen'
--

--
-- Dumping routines for database 'ypfrozen'
--
...
-- Dump completed on 2016-12-01 11:58:26
