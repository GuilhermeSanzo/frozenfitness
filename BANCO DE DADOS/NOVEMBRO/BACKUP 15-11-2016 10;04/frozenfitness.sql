...
(30, 'Teste', 1, NULL, 'Teste', 2, NULL),
(31, 'Super Dieta', 2, NULL, 'Foi descrito aqui que é muito bom', 1, NULL),
(32, 'Exclamação', 3, NULL, 'Acentuação é muito importante!', 1, NULL);
...
INSERT INTO `pedido` (`pedido_id`, `cliente_id`, `caminhao_id`, `status_id`) VALUES
(39, 16, NULL, NULL),
(40, 16, NULL, NULL),
(41, 16, NULL, NULL),
(42, 16, NULL, NULL),
...
(7, 'Filé de Frango a Milanesa com Bróculis', '1', 19.20, '../img/2.jpg', 2, 2.50, 'Prato muito gostoso, perfeito para quem quer perder peso', 2, 16, 3, '2016-11-04 15:18:17'),
...
(5, 'Separação de Ingredientes'),
(6, 'Pagamento Concluído');
...
(2, 'Guilherme', 'Souza', 'guilherme@email.com', 'emrehliug', 1, '1997-05-16', '789.456.123-05', '(11)4189-2489', 79.00, 1.98, 4, 2, NULL, 2),
(4, 'Samuel', 'Rocha', 'samuel.rocha.tj@outlook.com', '1234', 1, '1998-03-01', '446.442.348-50', '11961851582', 68.20, 1.68, 2, 2, NULL, 29),
(5, 'Miguel', 'Pitbull', 'miguelhenrique34@gmail.com', '1234', 1, '1996-03-25', '434.475.128-06', '11953023734', 90.00, 1.85, 1, 2, NULL, 5),
(6, 'Thalles', 'Vantini', 'thalles@email.com', '1234', 1, '1990-05-11', '489.658.912-23', '(11)4002-8922', 79.00, 1.94, 4, 2, NULL, 6),
(7, 'Lucas', 'Roberto', 'lucas@email.com', '1234', 1, '1988-08-08', NULL, NULL, NULL, NULL, NULL, 2, '', 7),
(8, 'Cliente', '1', 'cliente@email.com', '1234', 1, '1991-08-12', '156.987.123-12', '(21)4561-3214', 60.20, 1.82, 2, 1, NULL, 8),
(9, 'Administrativo', '', 'administrativo@email.com', '1234', 1, '1990-08-12', '654.789.123-78', '(11)4567-1234', 70.20, 2.80, 3, 3, NULL, 9),
(10, 'Marketing', '', 'marketing@email.com', '1234', 1, '1942-09-18', '465.547.987-82', '(11)4568-2314', 60.00, 1.80, 4, 4, NULL, NULL),
(11, 'Diretoria', '', 'diretoria@email.com', '1234', 1, '1940-08-02', '456.987.321-15', '(11)4567-3214', 60.20, 1.65, 4, 5, NULL, 0),
(12, 'Gerenciador', 'Usuários\r\n', 'gerenciador@email.com', '1234', 1, '1942-05-12', '456.987.320-15', '(11)4569-3248', 70.20, 1.72, 4, 6, NULL, 0),
...
--
ALTER TABLE `dieta`
  MODIFY `dieta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
--
...
--
ALTER TABLE `rel_dieta_pedido`
  MODIFY `rel_dieta_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `rel_dieta_prato`
--
ALTER TABLE `rel_dieta_prato`
  MODIFY `rel_dieta_prato_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
...
--
ALTER TABLE `rel_prato_pedido`
  MODIFY `rel_prato_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;
--
