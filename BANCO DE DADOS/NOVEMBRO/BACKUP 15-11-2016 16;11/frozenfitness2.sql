...
(7, 'Dieta para emagrecer', 1, NULL, 'Dieta para aquela pessoa que quer perder peso, além de modelar o corpo', 2, '2016-11-04 15:18:31'),
(30, 'Teste', 2, NULL, 'Teste', 2, NULL),
(31, 'Super Dieta', 2, NULL, 'Foi descrito aqui que é muito bom', 1, NULL),
(32, 'ExclamaÃ§Ã£o', 3, NULL, 'AcentuaÃ§Ã£o Ã© muito importante!', 1, NULL),
(33, 'teste', 3, NULL, 'teste', 1, NULL);
...
(5, 'Alameda', 'Parla', 860, '03248-260', 'Brooklyn', 'Belém', 'Pará', 2),
...
(24, 'Rua', 'Compra', 123, '06662-124', 'Barril', 'São Paulo', 'São Paulo', 1),
...
(29, 'Rua', 'Sônia Maria Ferreira de Andrade', 85, '06604-130', 'Jd. Novo Horizonte', 'Jandira', 'SP', 2),
...
(8, 'novo', 'img/contact.png', '(22) 9034-54545', 30, NULL);
...
(7, 'Filé de Frango a Milanesa com Bróculis', '1', 19.20, '../img/2.jpg', 2, 2.50, 'Prato muito gostoso, perfeito para quem quer perder peso', 2, 17, 3, '2016-11-04 15:18:17'),
(8, 'Sopa de Batata doce', '1', 20.50, '../img/sopa_batata_doce.jpg', 2, 3.00, 'Prato muito sadio, perfeito para quem quer perder peso', 2, 4, 2, '2016-11-04 15:18:17'),
(9, 'Porção de Cereal de milho', '1', 15.80, '../img/cereais.jpg', 2, 2.00, 'Prato muito atrativo, perfeito para quem quer perder peso', 2, 1, 2, '2016-11-04 15:18:17'),
(10, 'Porção de Corvina com arroz', '1', 36.00, '../img/corvina.jpg', 2, 3.00, 'Prato extremamente lindo, perfeito para quem quer perder peso', 2, 0, 2, '2016-11-04 15:18:17'),
(11, 'Salada de Beterraba com Nozes', '1', 15.50, '../img/salada_beterraba_nozes.jpg', 2, 1.00, 'Prato nutritivo, perfeito para quem quer perder peso', 2, 4, 2, '2016-11-04 15:18:17'),
(13, 'Filé de Frango a Milanesa com Bróculis', '1', 19.20, '../img/2.jpg', 2, 4.00, 'Prato muito gostoso, perfeito para quem quer perder peso', 1, 25, 2, '2016-11-04 15:18:17'),
(14, 'Sopa de Batata doce', '1', 20.50, '../img/sopa_batata_doce.jpg', 2, 4.00, 'Prato muito sadio, perfeito para quem quer perder peso', 1, 4, 3, '2016-11-04 15:18:17'),
(15, 'Porção de Cereal de milho', '1', 15.80, '../img/cereais.jpg', 2, 4.00, 'Prato muito atrativo, perfeito para quem quer perder peso', 1, 0, 3, '2016-11-04 15:18:17'),
(16, 'Porção de Corvina com arroz', '1', 36.00, '../img/corvina.jpg', 2, 4.00, 'Prato extremamente lindo, perfeito para quem quer perder peso', 1, 13, 2, '2016-11-04 15:18:17'),
(17, 'Salada de Beterraba com Nozes', '1', 15.50, '../img/salada_beterraba_nozes.jpg', 2, 4.00, 'Prato nutritivo, perfeito para quem quer perder peso', 1, 4, 2, '2016-11-04 15:18:17'),
(21, 'Macarrão Integral com Carne Desfiada', '1', 12.00, '../img/MacarraoCarneDesfiada_Pratos.jpg', 2, 1.05, 'Prato nutritivo, perfeito para quem quer perder peso', 2, 1, 2, '2016-11-04 15:18:17'),
(24, 'Teste', '3', 10.00, '../img/teste.jpg', 2, 1.00, 'teste', 1, NULL, 2, NULL);
...
(2, 'Guilherme', 'Souza', 'guilherme@email.com', 'emrehliug', 1, '1997-05-16', '789.456.123-05', '(11)4189-2489', 79.00, 1.98, 4, 2, 'img/usuario/G-hacker-boy_02.jpg', 2),
(4, 'Samuel', 'Rocha', 'samuel.rocha.tj@outlook.com', '1234', 1, '1998-03-01', '446.442.348-50', '11961851582', 68.20, 1.68, 2, 2, 'img/usuario/img_user.png', 29),
...
(8, 'Cliente', '1', 'cliente@email.com', '1234', 1, '1991-08-12', '156.987.123-12', '(21)4561-3214', 60.20, 1.82, 2, 1, 'img/usuario/img_user.png', 8),
...
--
ALTER TABLE `dieta`
  MODIFY `dieta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
--
-- AUTO_INCREMENT for table `endereco`
--
ALTER TABLE `endereco`
  MODIFY `endereco_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `faleconosco`
--
ALTER TABLE `faleconosco`
  MODIFY `fale_conosco_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
...
--
ALTER TABLE `parceiro`
  MODIFY `parceiro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `pedido`
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;
--
...
--
ALTER TABLE `rel_dieta_pedido`
  MODIFY `rel_dieta_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT for table `rel_dieta_prato`
--
ALTER TABLE `rel_dieta_prato`
  MODIFY `rel_dieta_prato_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
...
--
ALTER TABLE `rel_prato_pedido`
  MODIFY `rel_prato_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=125;
--
-- AUTO_INCREMENT for table `rel_prato_promocao`
--
ALTER TABLE `rel_prato_promocao`
  MODIFY `rel_prato_promocao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
