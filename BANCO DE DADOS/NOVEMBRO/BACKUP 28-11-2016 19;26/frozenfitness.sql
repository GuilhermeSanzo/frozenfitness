...
(124, 2, NULL, 1, 25.80, NULL, '2016-11-21'),
(125, 8, NULL, 1, 26.40, '2016-11-18', '2016-11-21'),
(126, 8, NULL, 1, 25.80, '2016-11-18', '2017-02-20'),
(127, 8, NULL, 1, 25.80, '2016-11-18', '2016-11-21'),
(128, 2, NULL, 1, 25.80, NULL, NULL),
(129, 8, NULL, 1, 25.80, NULL, NULL),
(130, 2, NULL, 1, 48.80, NULL, '2016-11-30'),
(131, 2, NULL, 1, 38.80, NULL, NULL),
(132, 15, NULL, 1, 22.64, NULL, '0000-00-00'),
(133, 15, NULL, 1, 22.64, NULL, '2016-11-30'),
(134, 8, NULL, 1, 25.50, NULL, '2016-12-01'),
(135, 8, NULL, 1, 26.40, NULL, '2016-12-10'),
(136, 8, NULL, 1, 38.80, NULL, '2016-12-01'),
(137, 15, NULL, 1, 83.34, NULL, '2016-12-01'),
(138, 15, NULL, 1, 25.50, NULL, '2016-12-01'),
(139, 15, NULL, 1, 25.50, NULL, '2016-12-01');
...
(13, 'Filé de Frango a Milanesa com Bróculis', '1', 19.20, '../img/2.jpg', 2, 4, 'Prato muito gostoso, perfeito para quem quer perder peso', 1, 30, 2, '2016-11-04 15:18:17'),
...
(13, 'SAC', '', 'sac@email.com', '1234', 1, '1982-07-03', '654.706.984-324', '(12)4896-3247', 60.80, 1.71, 2, 7, NULL, NULL),
(14, 'Any', 'Body', 'anybody@email.com', '1234', 0, '2000-12-02', '654.790.327-65', '(12)4843-2023', 60.70, 1.70, 1, 1, 'img/usuario/img_user.png', NULL),
(15, 'Celular', 'Smartphone', 'celular@email.com', '1234', 0, '1990-02-11', '747.228.485-88', '(11)6474-8585', 60.20, 1.72, 1, 1, 'img/usuario/img_user.png', 36);
...
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;
--
...
--
ALTER TABLE `rel_dieta_pedido`
  MODIFY `rel_dieta_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
--
...
--
ALTER TABLE `rel_prato_pedido`
  MODIFY `rel_prato_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
--
...
--
ALTER TABLE `rel_status_pedido`
  MODIFY `rel_status_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
