...
INSERT INTO `aprovacao` (`aprovacao_id`, `nome`) VALUES
...
INSERT INTO `banner` (`banner_id`, `nome`, `caminho_imagem`) VALUES
(1, 'bannerzao', 'img/banner1.png'),
(3, 'bannerlinho', 'img/banner3.png'),
(4, 'bannerlazo', 'img/banner4.png');
...
CREATE TABLE `caminhao` (
  ...
  `estado_atuacao` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `caminhao` (`caminhao_id`, `placa`, `latitude`, `longitude`, `transportadora_id`, `motorista_id`, `estado_atuacao`) VALUES
(1, 'RFE-7410', 21.50703349, 55.41190810, 2, 1, '26'),
(2, 'GTR-6412', 21.50703349, 55.41190810, 3, 2, '26'),
(3, 'UYG-7089', 21.50703349, 55.41190810, 1, 3, '26'),
(4, 'bcd-127', 21.50703349, 55.41190810, 7, 3, '26'),
(5, 'BCD-0127', 21.50703349, 55.41190810, 8, 2, '26'),
(6, 'EPX-1234', 21.50703349, 55.41190810, 1, 5, '16');
...
INSERT INTO `categoria_artigo` (`categoria_artigo_id`, `nome`) VALUES
(1, 'Dieta'),
(2, 'Treino'),
(3, 'Suplementação'),
(4, 'Aeróbico'),
...
--
-- Extraindo dados da tabela `categoria_fale_conosco`
--

INSERT INTO `categoria_fale_conosco` (`categoria_id`, `nome`) VALUES
(1, 'Sugestão'),
(2, 'Reclamação'),
(3, 'Elogio'),
(6, 'Dúvidas'),
...
INSERT INTO `dieta` (`dieta_id`, `nome`, `tipo_dieta_id`, `tipo_usuario_id`, `descricao`, `aprovacao_id`, `horario_aprovacao`) VALUES
(35, 'Pratos Leves', 1, NULL, 'Uma dieta feita com pratos leves e saudáveis, perfeita para quem quer emagrecer e não quer ficar sempre faminto.', 2, NULL);
...
CREATE TABLE `endereco` (
  ...
  `logradouro` varchar(25) DEFAULT 'Rua',
  `nome` varchar(100) DEFAULT NULL,
...
INSERT INTO `endereco` (`endereco_id`, `logradouro`, `nome`, `numero`, `cep`, `bairro`, `cidade`, `estado`, `tipo_endereco_id`) VALUES
(2, 'Rua', 'Ruanda', 321, '07892-234', 'Nova Orleans', 'Recife', 'PE', 2),
(4, 'Rua', 'Serrinhas', 789, '04562-684', 'Perus', 'Salvador', 'BA', 2),
(6, 'Rua', 'Gueto', 531, '07896-324', 'Vila Olimpia', 'Florianópolis', 'SC', 2),
(7, 'Rua', 'Meiota', 124, '03214-234', 'Rosevelt', 'Rio Branco', 'AC', 2),
(8, 'Rua', 'Presidente Carlão Ban', 631, 'Olaria', '04567-321', 'Macapá', 'AP', 2),
(9, 'Rua', 'Runaldo', 123, 'Barril', '06669-878', 'Porto Velho', 'RR', 2),
(23, 'Rua', 'Compra', 123, '06662-124', 'Barril', 'São Paulo', 'SP', 2),
(25, 'Quilômetro', 'Compra', 123, '06662-124', 'Barril', 'São Paulo', 'SP', 1),
(26, 'Rua', 'Runeira', 123, '06623480', 'Barrillo', 'Cidadela', 'PE', 2),
(27, 'Rua', 'Da Tristeza', 666, '06666-667', 'da Amargura', 'Decepções', 'RN', 2),
(28, 'Avenida', 'Teste', 123, '06604-130', 'Barril', 'Castelo', 'SP', 2),
(29, 'Rua', 'Sônia Maria F. de Andrade', 85, '06604-130', 'Jardim Novo Horizonte', 'Jandira', 'SP', 2),
(30, 'Alameda', 'Olaria', 12345, 'Barril', '62324-687', 'Cidadela', 'SC', 1),
(31, 'Rua', 'Maçanetas', 123, '06579-884', 'Barril', 'Cidadela', 'SP', 1),
(32, 'Rua', 'Rua1', 1231, 'Mapado1', '09032-632', 'Marcada1', 'SP', 1),
(33, 'Rua', 'Seatloft', 123, '06547-893', 'Windows', 'Micro', 'SP', 1),
(34, 'Rua', 'Rua1', 1233, '52121-212', 'teste1', 'teste1', 'SP', 1),
(35, 'Rua', 'Rua1', 901, '06548-972', 'Alto da Lapa', 'São Paulo', 'SP', 1),
(36, 'Rua', 'Augusta', 10, '01412-100', 'Cerqueira César', 'São Paulo', 'SP', 2);
...
INSERT INTO `faleconosco` (`fale_conosco_id`, `nome`, `email`, `titulo`, `mensagem`, `categoria`, `status`) VALUES
(4, 'guilherme', 'guilherme@email.com', 'oloco', 'mensagem muito louca', 3, 1),
(6, 'Joselito Alves', 'joselito@email.com', 'Quero meu café', 'Bota um cafezinho para nós aí po, não custa nada.\r\nNa verdade custa, mas libera aeeee!!!\r\n', 2, 1),
(27, 'teste', 'teste@teste', 'teste', 'teste', 1, 1),
(28, 'falando', 'falando@conosco', 'falando', 'falando conosco', 7, 1),
(29, 'Teste', 'teste@teste', 'Teste', 'teste', 1, 1);
...
INSERT INTO `fornecedor` (`fornecedor_id`, `razao_social`, `nome_fantasia`, `cnpj`, `endereco_id`) VALUES
(1, 'apple', 'mapple', '1234567', 5),
(6, 'Alphabet XYZ', 'Alphabet', '62.332.532/3478-98', 8),
(7, 'Transporte SA', 'Transporte', '12.121.212/1212-12', 9),
(8, 'gss inc.', 'guilherme ss', '6547896', 10),
(9, 'gss inc.', 'guilherme ss', '6547895', 11),
(10, 'gss inc.', 'guilherme ss', '6547894', 12),
(11, 'microsoft', 'Prato', '6547893', 13),
(12, 'microsoft', 'Prato', '6547892', 14),
(13, 'teste', 'Prato', '2434234', 15),
(14, 'Fornecedora Ltda.', 'Fornecedora', '12.334.568/9086-52', 30);
...
--
-- Extraindo dados da tabela `horario_do_dia`
--

INSERT INTO `horario_do_dia` (`horario_do_dia_id`, `nome`) VALUES
(1, 'Manhã'),
(2, 'Tarde'),
(3, 'Noite'),
(5, 'Madrugada');
...
INSERT INTO `ingrediente` (`ingrediente_id`, `nome`, `unidade_id`, `kcal_por_100g`, `tipo_ingrediente_id`, `caminho_imagem`) VALUES
(3, 'Arroz Branco', 14, 120, 1, 'img/arroz.jpg'),
(4, 'Feijao', 14, 150, 1, 'img/feijao.jpg'),
(5, 'Peixe', 14, 90, 2, 'img/Peixe_Ingrediente.jpg'),
(6, 'Carne de Boi', 14, 100, 3, 'img/carne.jpg'),
(7, 'Molusco', 14, 100, 4, 'img/molusco.jpg'),
(8, 'Macarrão', 14, 100, 6, 'img/macarrao.jpg'),
(9, 'Batata', 14, 100, 9, 'img/batata.png'),
(11, 'Tomate', 14, 350, 10, 'img/tomate.jpg'),
(12, 'Filé de Frango', 14, 360, 2, 'img/file_frango.jpg'),
(13, 'Batata Doce', 14, 150, 9, 'img/batata_doce.jpg'),
(14, 'Salsinha', 14, 30, 8, 'img/salsinha.jpg'),
(15, 'Milho', 14, 100, 1, 'img/milho.png'),
(16, 'Beterraba', 14, 60, 9, 'img/beterraba.jpg'),
(17, 'Noz', 14, 20, 10, 'img/nozes.jpg');
...
INSERT INTO `motorista` (`motorista_id`, `email`, `senha`, `nome`, `data_nascimento`, `cnh`, `celular`) VALUES
(1, 'lucas@roberto.com', '123', 'Lucas Roberto dos Santos Editado', '1990-10-04', '52.166.782-3', '011953023734'),
(2, 'muel.casado@gmail.com', '40bd001563085fc35165329ea1ff5c5ecbdbbeef', 'Samuel Rocha da Silva', '1996-03-06', '65.777.969-5', '011983486367'),
(3, 'tadas.godoi@outlook.com', '123', 'Tadao Godoi Penismuxa', '1994-02-15', '89.412.586-9', '011945697739'),
(4, 'thalles@teste.com', '123', 'Thalles Roberto Editado', '2016-10-17', '0002200', '945455454'),
(5, 'guilherme@motorista.com', '1234', 'Guilherme', '1997-06-11', '123456789', '11955552222');
...
INSERT INTO `operacao` (`operacao_id`, `nome`) VALUES
(1, 'Adicionar'),
(3, 'Remover');
...
INSERT INTO `parceiro` (`parceiro_id`, `nome`, `caminho_imagem`, `telefone`, `endereco_id`, `link`) VALUES
(6, 'Suplementos Alimentares - Espartanos', 'img/Espartanos_Parceiros.jpg', '(11) 3384-0500', 24, NULL),
(7, 'CentralFit', 'img/CentralFit_Parceiros.png', '(11)3615-2503', 25, NULL),
(9, 'Apple', 'img/apple.png', '(11) 3322-3232', 31, NULL),
(10, 'Microsoft', 'img/microsoft.png', '(11) 1239-8322', 33, NULL);
...
INSERT INTO `pedido` (`pedido_id`, `cliente_id`, `caminhao_id`, `status_id`, `total_pedido`, `data_pedido`, `dt_entrega_solic`) VALUES
(123, 8, NULL, 6, 180.40, '2016-11-17', '2016-11-25'),
(124, 2, 6, 6, 25.80, '2016-11-01', '2016-11-21'),
(125, 8, NULL, 3, 26.40, '2016-11-18', '2016-11-21'),
(126, 8, NULL, 1, 25.80, '2016-11-18', '2017-02-20'),
(127, 8, NULL, 1, 25.80, '2016-11-18', '2016-11-21'),
(130, 2, NULL, 1, 48.80, '2016-11-01', '2016-11-30'),
(132, 15, NULL, 1, 22.64, '2016-11-01', '0000-00-00'),
(133, 15, NULL, 1, 22.64, '2016-11-01', '2016-11-30'),
(134, 8, NULL, 1, 25.50, '2016-11-01', '2016-12-01'),
(135, 8, NULL, 1, 26.40, '2016-11-01', '2016-12-10'),
(136, 8, NULL, 1, 38.80, '2016-11-01', '2016-12-01'),
(137, 15, NULL, 1, 83.34, '2016-11-01', '2016-12-01'),
(138, 15, NULL, 1, 25.50, '2016-11-01', '2016-12-01'),
(139, 15, NULL, 1, 25.50, '2016-11-01', '2016-12-01'),
(140, 15, NULL, 1, 110.44, '2016-11-01', '2016-12-03'),
(141, 15, NULL, 1, 143.92, '2016-11-01', '2016-12-03'),
(143, 8, NULL, 1, 38.80, '2016-11-30', '2016-12-04'),
(146, 8, NULL, 1, 38.80, '2016-11-30', '2016-12-04'),
(147, 8, NULL, 1, 22.64, '2016-11-30', '2016-12-04'),
(148, 2, NULL, 1, 22.64, '2016-11-30', '2016-12-30'),
(151, 15, NULL, 1, 311.80, '2016-12-01', '2016-12-04'),
(153, 2, NULL, 1, 26.40, '2016-12-02', '2016-12-05'),
(154, 4, 3, 6, 26.40, '2016-12-02', '2016-12-06');
...
INSERT INTO `prato` (`prato_id`, `nome`, `validade`, `valor_unitario`, `caminho_imagem`, `tipo_usuario_id`, `tempo_preparo`, `descricao`, `tipo_dieta_id`, `qtde_visualizacoes`, `aprovacao_id`, `horario_aprovacao`) VALUES
(7, 'Filé de Frango a Milanesa com Bróculis', '1', 19.20, '../img/2.jpg', 2, 2, 'Prato muito gostoso, perfeito para quem quer perder peso', 2, 19, 3, '2016-11-04 15:18:17'),
(8, 'Sopa de Batata doce', '1', 20.50, '../img/sopa_batata_doce.jpg', 2, 3, 'Prato muito sadio, perfeito para quem quer perder peso', 2, 73, 2, '2016-11-04 15:18:17'),
(9, 'Porção de Cereal de milho', '1', 15.80, '../img/cereais.jpg', 2, 2, 'Prato muito atrativo, perfeito para quem quer perder peso', 2, 14, 2, '2016-11-04 15:18:17'),
(10, 'Porção de Corvina com arroz', '1', 36.00, '../img/corvina.jpg', 2, 3, 'Prato extremamente lindo, perfeito para quem quer perder peso', 2, 0, 2, '2016-11-04 15:18:17'),
(11, 'Salada de Beterraba com Nozes', '1', 15.50, '../img/salada_beterraba_nozes.jpg', 2, 1, 'Prato nutritivo, perfeito para quem quer perder peso', 2, 5, 2, '2016-11-04 15:18:17'),
(13, 'Filé de Frango a Milanesa com Bróculis', '1', 19.20, '../img/2.jpg', 2, 4, 'Prato muito gostoso, perfeito para quem quer perder peso', 1, 31, 2, '2016-11-04 15:18:17'),
(14, 'Sopa de Batata doce', '1', 20.50, '../img/sopa_batata_doce.jpg', 2, 4, 'Prato muito sadio, perfeito para quem quer perder peso', 1, 4, 3, '2016-11-04 15:18:17'),
(15, 'Porção de Cereal de milho', '1', 15.80, '../img/cereais.jpg', 2, 4, 'Prato muito atrativo, perfeito para quem quer perder peso', 1, 0, 3, '2016-11-04 15:18:17'),
(16, 'Porção de Corvina com arroz', '1', 36.00, '../img/corvina.jpg', 2, 4, 'Prato extremamente lindo, perfeito para quem quer perder peso', 1, 13, 2, '2016-11-04 15:18:17'),
(17, 'Salada de Beterraba com Nozes', '1', 15.50, '../img/salada_beterraba_nozes.jpg', 2, 4, 'Prato nutritivo, perfeito para quem quer perder peso', 1, 4, 2, '2016-11-04 15:18:17'),
(21, 'Macarrão Integral com Carne Desfiada', '1', 12.00, '../img/MacarraoCarneDesfiada_Pratos.jpg', 2, 1, 'Prato nutritivo, perfeito para quem quer perder peso', 2, 1, 2, '2016-11-04 15:18:17'),
(25, 'Proclamação', '2', 10.00, '../img/teste.jpg', 2, 3, 'Proclamação', 1, NULL, 2, NULL),
(26, 'Clássico Brasileiro', '2', 10.00, '../img/classico_brasileiro.jpg', 2, 2, 'Esse é o famoso prato brasileiro que está presente nos lares da maioria dos brasileiros, porém em uma versão fitness para quem deseja comer bem, e de forma saudável.', 2, 11, 2, NULL);
...
INSERT INTO `promocao` (`promocao_id`, `nome`, `porcentagem_desc`) VALUES
(1, 'Promoção de Verão', 20.00),
(2, 'Promoção de Inverno', 20.00);
...
--
-- Extraindo dados da tabela `rel_dieta_pedido`
--

INSERT INTO `rel_dieta_pedido` (`rel_dieta_pedido_id`, `dieta_id`, `qtde`, `pedido_id`) VALUES
(54, 35, 5, 117),
(55, 35, 1, 121),
(56, 35, 3, 123),
(57, 35, 1, 140),
...
--
-- Extraindo dados da tabela `rel_dieta_prato`
--

INSERT INTO `rel_dieta_prato` (`rel_dieta_prato_id`, `dia`, `horario_do_dia_id`, `prato_id`, `dieta_id`) VALUES
(37, 1, 1, 14, 35),
(38, 2, 2, 9, 35),
(42, 3, 3, 17, 35);
...
--
-- Extraindo dados da tabela `rel_ingrediente_fornecedor`
--

INSERT INTO `rel_ingrediente_fornecedor` (`rel_ingrediente_fornecedor_id`, `fornecedor_id`, `ingrediente_id`) VALUES
(1, 1, 3),
(2, 6, 4),
(3, 6, 4),
(5, 6, 13),
...
--
-- Extraindo dados da tabela `rel_prato_ingrediente`
--

INSERT INTO `rel_prato_ingrediente` (`rel_prato_ingrediente_id`, `qtd`, `ingrediente_id`, `prato_id`) VALUES
(14, 301, 3, 7),
(15, 600, 12, 7),
(17, 130, 11, 7),
(18, 200, 13, 8),
...
--
-- Extraindo dados da tabela `rel_prato_pedido`
--

INSERT INTO `rel_prato_pedido` (`rel_prato_pedido_id`, `prato_id`, `qtde`, `pedido_id`) VALUES
(128, 25, 5, 117),
(129, 9, 2, 118),
(130, 9, 1, 119),
(131, 9, 1, 120),
...
--
-- Extraindo dados da tabela `rel_prato_promocao`
--

INSERT INTO `rel_prato_promocao` (`rel_prato_promocao_id`, `prato_id`, `promocao_id`) VALUES
(1, 7, 1),
(2, 8, 1),
(4, 10, 2),
(5, 9, 2),
...
--
-- Extraindo dados da tabela `rel_status_pedido`
--

INSERT INTO `rel_status_pedido` (`rel_status_pedido_id`, `ultima_atualizacao`, `status_id`, `pedido_id`) VALUES
(9, '2016-11-16 19:13:36', 1, 117),
(15, '2016-11-16 21:45:20', 1, 118),
(17, '2016-11-16 22:16:30', 2, 117),
(18, '2016-11-16 22:16:33', 2, 118),
(19, '2016-11-16 22:18:50', 3, 117),
(20, '2016-11-16 22:18:53', 3, 118),
(21, '2016-11-16 22:19:52', 4, 117),
(22, '2016-11-16 22:19:56', 4, 118),
(23, '2016-11-17 00:30:14', 5, 118),
(24, '2016-11-17 00:30:19', 5, 117),
(25, '2016-11-18 03:24:57', 1, 124),
(26, '2016-11-18 03:30:44', 1, 125),
(27, '2016-11-18 08:41:15', 1, 126),
(28, '2016-11-18 08:57:14', 1, 127),
(29, '2016-11-18 10:27:41', 1, 128),
(30, '2016-11-27 00:57:33', 1, 129),
(31, '2016-11-27 16:14:13', 1, 130),
(32, '2016-11-27 16:26:25', 1, 131),
(33, '2016-11-27 16:45:16', 1, 132),
(34, '2016-11-27 16:47:46', 1, 133),
(35, '2016-11-27 22:34:11', 1, 134),
(36, '2016-11-28 08:34:54', 1, 135),
(37, '2016-11-28 09:56:50', 1, 136),
(38, '2016-11-28 11:36:06', 1, 137),
(39, '2016-11-28 18:11:08', 1, 138),
(40, '2016-11-28 18:11:52', 1, 139),
(41, '2016-11-30 15:45:56', 1, 140),
(42, '2016-11-30 17:07:01', 1, 141),
(43, '2016-11-30 21:15:31', 1, 142),
(44, '2016-11-30 22:10:49', 1, 143),
(45, '2016-11-30 22:36:47', 1, 144),
(46, '2016-11-30 23:02:00', 1, 145),
(47, '2016-11-30 23:02:24', 1, 146),
(48, '2016-11-30 23:42:27', 1, 147),
(49, '2016-11-30 23:44:54', 1, 148),
(50, '2016-12-01 13:57:43', 1, 149),
(51, '2016-12-01 14:34:33', 1, 150),
(52, '2016-12-01 14:57:08', 1, 151),
(53, '2016-12-01 15:53:03', 1, 152),
(54, '2016-12-02 13:46:24', 2, 123),
(55, '2016-12-02 13:46:48', 2, 124),
(56, '2016-12-02 13:47:47', 2, 125),
(57, '2016-12-02 13:48:09', 3, 124),
(58, '2016-12-02 13:48:29', 4, 124),
(59, '2016-12-02 13:49:16', 5, 124),
(60, '2016-12-02 13:58:33', 1, 153),
(61, '2016-12-02 14:07:54', 6, 124),
(62, '2016-12-02 14:48:35', 1, 154),
(63, '2016-12-02 14:49:31', 2, 154),
(64, '2016-12-02 14:50:00', 3, 154),
(65, '2016-12-02 14:50:21', 4, 154),
(66, '2016-12-02 14:50:40', 5, 154),
(67, '2016-12-02 14:50:54', 6, 154),
(68, '2016-12-02 15:12:54', 3, 125);
...
(2, 'Aguardando Separação de Ingredientes'),
(3, 'Aguardando Preparo'),
(4, 'Aguardando Envio para Transportadora'),
(5, 'Pronto para envio'),
(6, 'Á Caminho'),
(7, 'Entregue');
...
--
-- Extraindo dados da tabela `tipo_dieta`
--

INSERT INTO `tipo_dieta` (`tipo_dieta_id`, `nome`, `caminho_imagem`, `cor`) VALUES
(1, 'Emagrecimento', 'img/emagrecimento_icon.png', 'purple'),
(2, 'Hipertrofia', 'img/hipertrofia_icon.png', '#34ABCF'),
(3, 'Kids', 'img/kids.jpg', '#FF0000');
...
INSERT INTO `tipo_endereco` (`tipo_endereco_id`, `nome`) VALUES
(1, 'Parceiro'),
(2, 'Cliente'),
(3, 'Fornecedor');
...
--
-- Extraindo dados da tabela `tipo_ingrediente`
--

INSERT INTO `tipo_ingrediente` (`tipo_ingrediente_id`, `nome`) VALUES
(1, 'Grãos'),
(2, 'Carne Branca'),
(3, 'Carne Vermelha'),
(4, 'Frutos do Mar'),
...
INSERT INTO `transportadora` (`transportadora_id`, `cnpj`, `razao_social`, `nome_fantasia`, `telefone`) VALUES
(1, '123', 'testando', 'qualquer', '456'),
(2, 'Lucas Roberto 2', '456', 'Teste 2', '0'),
(3, 'teste', '456', 'teste 3', '0'),
(5, '123', 'teste', 'testando', '456'),
(7, '00.094.549/0038-80', 'Tadeo Santoro', 'Tadas Ltda', '(11) 4143-7784'),
(8, '00.354.519/4031-50', 'Waffer SA', 'Waffer SA', '(13) 4343-7894'),
(9, '123', 'teste', 'testando', '456'),
(11, '789', 'testando', 'estouaqui', '456');
...
INSERT INTO `unidade` (`unidade_id`, `nome`, `abreviatura`) VALUES
(14, 'grama', 'g'),
(15, 'unidade', 'unid'),
(20, 'kilograma', 'kg'),
(22, 'litro', 'l'),
...
CREATE TABLE `usuario` (
  ...
  `tipo_dieta_id` int(11) DEFAULT NULL,
  `tipo_usuario_id` int(11) DEFAULT NULL,
  `caminho_imagem` varchar(100) DEFAULT 'img/usuario/img_user.png',
  `endereco_id` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `usuario` (`usuario_id`, `nome`, `sobre_nome`, `email`, `senha`, `sexo`, `data_nascimento`, `cpf`, `telefone`, `peso`, `altura`, `tipo_dieta_id`, `tipo_usuario_id`, `caminho_imagem`, `endereco_id`) VALUES
(2, 'Guilherme', 'Souza', 'guilherme@email.com', 'emrehliug', 1, '1997-05-16', '789.456.123-05', '(11)4189-2489', 79.00, 1.98, 2, 2, 'img/usuario/G-hacker-boy_01.jpg', 2),
(4, 'Samuel', 'Rocha', 'samuel.rocha.tj@outlook.com', '1234', 1, '1998-03-02', '446.442.348-50', '11961851582', 68.20, 1.68, 2, 2, 'img/usuario/cliente.png', 29),
(5, 'Miguel', 'Pitbull', 'miguelhenrique34@gmail.com', '1234', 1, '1996-03-25', '434.475.128-06', '11953023734', 90.00, 1.85, 2, 2, 'img/usuario/img_user.png', 5),
(6, 'Thalles', 'Vantini', 'thalles@email.com', '1234', 1, '1990-05-11', '489.658.912-23', '(11)4002-8922', 79.00, 1.94, 2, 2, 'img/usuario/img_user.png', 6),
(7, 'Lucas', 'Roberto', 'lucas@email.com', '1234', 1, '1988-08-08', NULL, NULL, NULL, NULL, NULL, 2, 'img/usuario/img_user.png', 7),
(8, 'Cliente', 'Compradora', 'cliente@email.com', '1234', 0, '1996-08-12', '356.987.123-12', '(21)4561-3214', 65.20, 1.75, 1, 1, 'img/usuario/customer_female_light_256.png', 8),
(9, 'Administrativo', '', 'administrativo@email.com', '1234', 1, '1990-08-12', '654.789.123-78', '(11)4567-1234', 70.20, 2.80, 2, 3, 'img/usuario/img_user.png', 9),
(10, 'Marketing', '', 'marketing@email.com', '1234', 1, '1942-09-18', '465.547.987-82', '(11)4568-2314', 60.00, 1.80, 2, 4, 'img/usuario/img_user.png', NULL),
(11, 'Diretoria', '', 'diretoria@email.com', '1234', 1, '1940-08-02', '456.987.321-15', '(11)4567-3214', 60.20, 1.65, 2, 5, 'img/usuario/img_user.png', 0),
(12, 'Gerenciador', 'Usuários\r\n', 'gerenciador@email.com', '1234', 1, '1942-05-12', '456.987.320-15', '(11)4569-3248', 70.20, 1.72, 2, 6, 'img/usuario/img_user.png', 0),
(13, 'SAC', '', 'sac@email.com', '1234', 1, '1982-07-03', '654.706.984-324', '(12)4896-3247', 60.80, 1.71, 2, 7, 'img/usuario/img_user.png', NULL),
(14, 'Any', 'Body', 'anybody@email.com', '1234', 0, '2000-12-02', '654.790.327-65', '(12)4843-2023', 60.70, 1.70, 1, 1, 'img/usuario/img_user.png', NULL),
(15, 'Celular', 'Smartphone', 'celular@email.com', '1234', 0, '1990-02-11', '747.228.485-88', '(11)6474-8585', 60.20, 1.72, 1, 1, 'img/usuario/smartphone.jpg', 36);
...
--
ALTER TABLE `caminhao`
  MODIFY `caminhao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `dieta`
  MODIFY `dieta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
--
-- AUTO_INCREMENT for table `endereco`
--
ALTER TABLE `endereco`
  MODIFY `endereco_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `faleconosco`
--
ALTER TABLE `faleconosco`
  MODIFY `fale_conosco_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
-- AUTO_INCREMENT for table `fornecedor`
--
ALTER TABLE `fornecedor`
  MODIFY `fornecedor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `parceiro`
  MODIFY `parceiro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `pedido`
--
ALTER TABLE `pedido`
  MODIFY `pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;
--
...
--
ALTER TABLE `rel_dieta_pedido`
  MODIFY `rel_dieta_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=59;
--
-- AUTO_INCREMENT for table `rel_dieta_prato`
--
ALTER TABLE `rel_dieta_prato`
  MODIFY `rel_dieta_prato_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
...
--
ALTER TABLE `rel_prato_ingrediente`
  MODIFY `rel_prato_ingrediente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `rel_prato_pedido`
--
ALTER TABLE `rel_prato_pedido`
  MODIFY `rel_prato_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=171;
--
-- AUTO_INCREMENT for table `rel_prato_promocao`
--
ALTER TABLE `rel_prato_promocao`
  MODIFY `rel_prato_promocao_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `rel_status_pedido`
--
ALTER TABLE `rel_status_pedido`
  MODIFY `rel_status_pedido_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
--
...
--
ALTER TABLE `tipo_endereco`
  MODIFY `tipo_endereco_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `tipo_ingrediente`
--
ALTER TABLE `tipo_ingrediente`
  MODIFY `tipo_ingrediente_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
