		...
		<div class="conteudo">
			...
			<div class="esp_categoria">
				<div class="box_categoria">
					<div class="icon_categoria"></div>
					<div class="categoria"><a href="categoria.php?tipo_dieta_id=2"> Hipertrofia </a></div>
					<div class="box_avancar" id="anterior"></div>
					<div class="box_avancar" id="proximo"></div>
					<div class="box_produtos" id="produtos_hipertrofia">

					</div>
				</div>

				<div class="box_categoria">
					<div class="icon_categoria" style="background-image:url(img/emagrecimento_icon.png)"></div>
					<div class="categoria"><a href="categoria.php?tipo_dieta_id=1"> Emagrecimento </a></div>
					<div class="box_avancar" id="anterior2"></div>
					<div class="box_avancar" id="proximo2"></div>
					<div class="box_produtos" id="produtos_emagrecimento">
		...
		<div class="box_localizacao_frase_cartoes">
			<div class="box_localizacao">
				...
				<p class="localizacao_description">
					Rua Mooca, 171 - Jd. Senai - São Paulo - 06660-177
				</p>
			</div>
			<div class="box_frase">
				<div class="frase">
